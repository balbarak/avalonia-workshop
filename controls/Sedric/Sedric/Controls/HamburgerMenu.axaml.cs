...
public class HamburgerMenu : TemplatedControl
{
    ...
    public static readonly StyledProperty<bool> IsOpenProperty = AvaloniaProperty.Register<HamburgerMenu, bool>(nameof(IsOpen),defaultValue: false,notifying:OnIsOpenPropertyChanged);

    public static readonly StyledProperty<object> ContentProperty = AvaloniaProperty.Register<HamburgerMenu, object>(nameof(IsOpen),defaultValue: null);
    ...
    private static void OnIsOpenPropertyChanged(AvaloniaObject arg1, bool arg2)
    {
